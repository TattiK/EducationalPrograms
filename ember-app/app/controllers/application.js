      ...
      nodes: [
        {
          ...
          link: null,
          caption: i18n.t('forms.application.sitemap.образовательные-программы.caption'),
          title: i18n.t('forms.application.sitemap.образовательные-программы.title'),
          children: [{
            link: 'i-i-s-educational-program-semestr-l',
            caption: i18n.t('forms.application.sitemap.образовательные-программы.i-i-s-educational-program-semestr-l.caption'),
            title: i18n.t('forms.application.sitemap.образовательные-программы.i-i-s-educational-program-semestr-l.title'),
            children: null
          }, {
            link: 'i-i-s-educational-program-contract-l',
            caption: i18n.t('forms.application.sitemap.образовательные-программы.i-i-s-educational-program-contract-l.caption'),
